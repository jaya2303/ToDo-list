...
export default function ReadAloudTab() {
  ...
  const [voiceVolume, setVoiceVolume] = useState<number>(user.settings.voiceVolume ?? 1);

  const [prevVoiceVol, setPrevVoiceVol] = useState<number>(user.settings.voiceVolume ?? 1);
  ...
  const handleMuteClick = () => {
    ...
    setVoiceVolume(newVoiceVolume ?? 1);
  };
